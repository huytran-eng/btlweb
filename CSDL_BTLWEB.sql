...
-- Schema webhd
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webhd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
-- -----------------------------------------------------
-- Schema btlweb
-- -----------------------------------------------------
...
-- Table `webhd`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`user` (
...
-- -----------------------------------------------------
-- Table `webhd`.`question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`question` (
  ...
  INDEX `FK_question_user` (`user_id` ASC) VISIBLE,
  CONSTRAINT `FK_question_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `webhd`.`user` (`user_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- Table `webhd`.`answer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`answer` (
  ...
  CONSTRAINT `FK8frr4bcabmmeyyu60qt7iiblo`
    ...
    REFERENCES `webhd`.`question` (`question_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `webhd`.`answer_downvote`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`answer_downvote` (
  `answer_id` VARCHAR(255) NOT NULL,
  `user_id` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `FKlcri6qu8ux4xwpxhg26veevb3`
    ...
    REFERENCES `webhd`.`answer` (`answer_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `webhd`.`answer_pic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`answer_pic` (
  `answer_id` VARCHAR(255) NOT NULL,
  `answer_pic` VARCHAR(255) NULL DEFAULT NULL,
  UNIQUE INDEX `UKq81mrcqp7cr3v04jd4v59886w` (`answer_id` ASC, `answer_pic` ASC),
...
-- -----------------------------------------------------
-- Table `webhd`.`answer_upvote`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`answer_upvote` (
  `answer_id` VARCHAR(255) NOT NULL,
  `user_id` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`answer_id`, `user_id`),
...
-- -----------------------------------------------------
-- Table `webhd`.`question_downvote`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`question_downvote` (
  `question_id` VARCHAR(255) NOT NULL,
  `user_id` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `webhd`.`question_pic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`question_pic` (
  `question_id` VARCHAR(255) NOT NULL,
  `question_pic` VARCHAR(255) NULL DEFAULT NULL,
...
-- Table `webhd`.`tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`tag` (
...
-- -----------------------------------------------------
-- Table `webhd`.`question_tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`question_tag` (
  `question_id` VARCHAR(255) NOT NULL,
  `tag_id` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`question_id`, `tag_id`),
  INDEX `FKnacet7y1n8llxvrbmm3xdq13j` (`tag_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `webhd`.`question_upvote`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webhd`.`question_upvote` (
  `question_id` VARCHAR(255) NOT NULL,
  `user_id` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`question_id`, `user_id`),
